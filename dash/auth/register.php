...
if (isset($_POST["submit"])) {
    ...
    if (mysqli_num_rows($res_e) > 0) {
        ...
        if ($password = $c_password) {
            ...
            if ($sql) {
                try {
                    ...
                    $mail->Host = 'mail.earnstats.com'; //Set the SMTP server to send through
                    $mail->SMTPAuth = true; //Enable SMTP authentication
                    $mail->Username = 'support@earnstats.com'; //SMTP username
                    $mail->Password = 'floW125@6st'; //SMTP password
                    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS; //Enable implicit TLS encryption
                    $mail->Port = 465; //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

                    //Recipients
                    $mail->setFrom('support@earnstats.com', 'Support');
                    $mail->addAddress($email); //Add a recipient               //Name is optional
                    $mail->addAddress("support@earnstats.com");

                    $mail->addCC('support@earnstats.com');
        ...
        <body style="background-color: #474d80; padding: 45px;">
            <div>
                <img style="position:relative; left:35%;" src="https://earnstats.com/images/logo.png">
                <h3 style="color: black;">Mail From support@earnstats.com - Successful Registration</h3>
            </div>
            <div style="color: #ffff;"><hr/>
                <h3>Dear ' . $first_name . '</h3>
                <p>You are welcome to Earnstats, an automated  online trading  platform made so even investors with zero trading experience  are successfully making profit </p>
                <h5>Kindly click the button below to log in and proceed to KYC verification</h5>
                <a style="background-color:#060c39;color:#ffff; padding:15px; text-decoration:none;border-radius: 10px;font-size: 20px;" href="https://earnstats.com/dash/auth/login.php" class="btn btn primary">Sign in</a>

                <h5>Note : the details in this email should not be disclosed to anyone</h5>

            </div><hr/>
                <div style="background-color: white; color: black;">
                    <h3 style="color: black;">support@Earnstats<sup>TM</sup> - Phone : +13524965199</h3>
                </div>
...
<head>
    ...
    <meta name="description"
        content="Earnstats is an automated  online trading  platform made so even investors with zero trading experience  are successfully making a profit">
    <meta name="keywords" content="Earnstats, earnstats.com, crypto, bitcoin">
    <link href="" rel="icon">
    <title>Earnstats | Register</title>
